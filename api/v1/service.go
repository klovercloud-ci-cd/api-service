...
// Get... Get Api
// @Summary Get api
// @Description Api for getting all Service by agent name, owner reference and process
// @Tags Service
// @Produce json
...
func (s serviceApi) Get(context echo.Context) error {
	...
	code, data := s.serviceService.Get(agent, ownerReference, processId, option)
	if code == 200 {
...
func NewServiceApi(serviceService service.Service, jwtService service.Jwt, processService service.Process) api.Service {
	return &serviceApi{
