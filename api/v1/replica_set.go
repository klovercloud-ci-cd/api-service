...
// Get... Get Api
// @Summary Get api
// @Description Api for getting all ReplicaSet by agent name, owner reference and process
// @Tags ReplicaSet
// @Produce json
...
func (r replicaSetApi) Get(context echo.Context) error {
	...
	code, data := r.replicaSetService.Get(agent, ownerReference, processId, option)
	if code == 200 {
...
// @Description Api for getting a ReplicaSet by id, agent name, and process id
// @Tags ReplicaSet
// @Produce json
...
func (r replicaSetApi) GetByID(context echo.Context) error {
	...
	code, data := r.replicaSetService.GetByID(id, agent, processId)
	if code == 200 {
		return context.JSON(code, data)
	}
	return common.GenerateErrorResponse(context, "[ERROR]: k8s Object Query Failed", "Operation Failed")
...
func NewReplicaSetApi(replicaSetService service.ReplicaSet, jwtService service.Jwt, processService service.Process) api.ReplicaSet {
